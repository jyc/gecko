...
ServoStyleSet::RegisterProperty(const nsAString& aName,
                                ...
                                const nsAString& aMaybeInitialValue)
{
  RefPtr<URLExtraData> urlExtraData =
    new URLExtraData(mDocument->GetDocBaseURI(),
                     mDocument->GetDocBaseURI(),
                     mDocument->NodePrincipal(),
                     mozilla::net::RP_Unset);
  return static_cast<PropertyRegistrationResult>(
    Servo_StyleSet_RegisterProperty(mRawSet.get(), urlExtraData, &aName,
                                    &aSyntax, aInherits, aInitialValueWasPassed,
                                    &aMaybeInitialValue));
}

PropertyRegistrationResult
ServoStyleSet::UnregisterProperty(const nsAString& aName)
{
  return static_cast<PropertyRegistrationResult>(
