 ...
 * style::properties_and_values::PropertyRegistrationResult on the Servo side.
 */
...
class ServoStyleSet {
 ...
 public:
  ...
  PropertyRegistrationResult RegisterProperty(
  ...
  PropertyRegistrationResult UnregisterProperty(const nsAString& aName);
